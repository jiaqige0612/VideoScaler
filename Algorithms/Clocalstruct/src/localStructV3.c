...
void stage1(uint8_t * val, uint16_t x, uint16_t y, uint16_t xdim, uint16_t ydim){
    ...
    5*(*(val + xdim*(y+1 - *(B)) + (x+1 - *(R)))) - *(val + xdim*(y+3 - *(B +1)) + x+3 - *(R+1))))>>3; 


    int16_t interpX135 = (-(*(val + xdim*(y-3 + *(A+1)) + x+3 - *(R+1))) + 5*((*(val + xdim*(y-1 + *(A)) + (x+1 - *(R))))) + \
    5*((*(val + xdim*(y+1 - *(B)) + (x-1 + *(L))))) - (*(val + xdim*(y+3 - *(B+1)) + x-3 + *(L+1))))>>3; 
    ...
    double w45 = (esf135+0.001) / (esf135+esf45+0.002);
    double w135 = 1 - w45;

    *(val + y*(xdim) + x) = (uint8_t) round(w45*interpX45 + w135*interpX135);
...
void stage2(uint8_t * val, uint16_t x, uint16_t y, uint16_t xdim, uint16_t ydim){
    ...
    double w0 = (esf90+0.00001) / (esf90+esf0 + 0.00002);
    double w90 = 1 - w0;

    *(val + xdim*(y) + x) = (uint8_t) round(w0*interpX0 + w90*interpX90);
